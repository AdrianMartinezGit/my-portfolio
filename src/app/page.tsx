...
export default function Page() {
  return (
    <>
      <main className="hidden 2xl:block"> {/* Desktop View */}
              ...
              <div className="flex justify-center">
                <div className="w-96 h-auto bg-white rounded-lg shadow-md shadow-black">
                  ...
                  <div className="p-5">
                    ...
                    <button className="bg-blue-500 p-4 text-white rounded-xl text-3xl w-full h-16 mt-5"><a href="https://react-weather-rebuild.vercel.app/">Go to Website</a></button>
                  </div>
                </div>
              </div>
        ...
        <div className="w-full h-auto bg-green-300 p-12">
          <div className="grid grid-cols-2">
            ...
            <div>
              ...
              <div className="grid grid-rows-3">
                <a className="text-3xl font-semibold text-black text-center underline mb-2 font-[Source-Code-Pro]" href="https://www.linkedin.com/in/adrian-martinez-97aa99306/">My LinkedIn</a>
                <a className="text-3xl font-semibold text-black text-center underline mb-2 font-[Source-Code-Pro]" href="https://github.com/AdrianMartinezGit">My Github</a>
                <a className="text-3xl font-semibold text-black text-center underline font-[Source-Code-Pro]" href="https://docs.google.com/document/d/10WvHDvvuObDEnTLxm8R_uT0VKye_1Nb3iMLUy7kF1r8/edit?usp=sharing">My Resume</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="p-2">
            <div className="sm:grid sm:grid-flow-row sm:grid-cols-2">
              ...
              <div>
                ...
                <div className="flex justify-center">
                  <div className="grid grid-flow-col w-48">
